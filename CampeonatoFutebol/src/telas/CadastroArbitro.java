 ...
 * @author Renan
 */
public class CadastroArbitro extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroArbitro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
